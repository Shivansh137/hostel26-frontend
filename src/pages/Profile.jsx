...
const imageUpload = async(e) => {
   ...
   const res = await fetch(`/profile/${studentData._id}/${studentData.profilePic}`, {
    method: "PATCH",
    headers: {
      'Accept': 'image/*'
    },
  ...
  return (
    ...
    <StyledProfile className=" df jce aic round3 center">
        ...
        <div id='profilePic' style={{ width: "30%", height: "60%", backgroundImage:`url(${`http://localhost:8000/images/${studentData.profilePic}`})`, backgroundSize:"100% 100%",overflow:"hidden"}} className='bgblue posrel mgb2 round3'>
